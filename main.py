...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет величину показателя атаки.
    Зависит от имени персонажа и его класса.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет величину показателя защиты.
    Блокируемый урон зависит от имени персонажа и его класса.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет вид и величину специального умения.
    Зависимост от имени персонажа и его класса.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбирает класс песонажа.
    Зависимост от выбора класса.
    Выводит описание класса. Подтверждает выбор.
    """
